...
function TestimonialCard({ name, role, image, quote }: { name: string; role: string; image: string; quote: string }) {
  return (
    ...
    >
      ...
      <p className="quote text-gray-200 font-light leading-relaxed">{quote}</p>
...
export default function Testimonials() {
  return (
    <section className="w-full py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white overflow-hidden">
